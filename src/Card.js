    ...
    <div className="card  w-[32%] h-fit shadow-lg   text-white  rounded-xl border-2  md:mt-28 mt-36">
      <div className="p-8">
        <div className="flex w-[100%] mb-3 items-center justify-between">
          <p className="text-xl font-semibold text-black w-[50%] mr-4 ">
            {name}
          </p>
          <p className="mt-2 text-black w-[40%] relative">
            <div className="flex text-yellow-300">{stars}</div>
          </p>
        </div>
        <div className="flex text-sm  w-full">
          {" "}
          <p className=" mr-1 text-gray-500">
            <i class="fa-solid fa-location-dot text-gray-600 mr-3"></i>
